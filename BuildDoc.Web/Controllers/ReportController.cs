...
namespace BuildDoc.Web.Controllers
{
    public class ReportController : Controller
    {
        ...
        public ActionResult DownloadDoc(decimal masterId)
        {
            ...
            string st = "{\"Header\":[{\"Key\":\"2\",\"Type\":\"Config\",\"Condition\":\"\",\"Name\":\"简单版预估-头部\"}],\"Detail\":[{\"Key\":\"3\",\"Type\":\"Config\",\"Condition\":\"\",\"Name\":\"简单版预估-中部\"}],\"Footer\":[{\"Key\":\"4\",\"Type\":\"Config\",\"Condition\":\"\",\"Name\":\"简单版预估-尾部\"}]}";
            DocMaster master = CreateDocMaster(masterId, 25033, st, 6541, 143, 389, false, ref error, false, 40016003, 1);
