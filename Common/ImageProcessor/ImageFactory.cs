...
using Common.ImageProcessor.Processors;
using System.Threading;
using System.Configuration;

namespace Common.ImageProcessor
{
    /// <summary>
    ...
    public class ImageFactory : IDisposable
    {
        ...
        public ImageFactory Load(string imagePath)
        {
           ...
           // LogManager log = new LogManager();
            ...
            //log.WriteLog("load-imageName:"+imageName);
            //log.WriteLog("load-path:" + path);
         
            FileInfo fi = new FileInfo(path);
           // log.WriteLog("load-exists:" + fi.Exists.ToString());
            if (fi.Exists)
            {
                this.ImagePath = path;
                this.QueryString = query;
             //   log.WriteLog("load-imagePath" + path);
        ...
        public ImageFactory Border(BorderLayer borderLayer)
        {
            if (this.ShouldProcess)
            {
                ...
                Borders borders = new Borders { DynamicParameter=borderLayer };
