...
namespace Common
{
    public class MathOpt2  //FittingFunct
    {  
	    /**
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="a">a: iOrder由大到小排列</param>
        /// <param name="iOrder"></param>
        /// <returns></returns>
        public static double calRSquare_polyfit(double[] x, double[] y, double[] a) {
		    ...
		    for (int i = 0; i < num; i++) {
                ...
                for (int n = 0; n < a.Length; n++) {
                    yLine[i] = yLine[i] + Math.Pow(x[i], a.Length - n -1 ) * a[n];
                } 
		    }

		    return calRSquare(x, y, yLine, 0, 0);
	    }
